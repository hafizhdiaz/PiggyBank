...
import org.example.bnsp.DataBase.DataBaseAccess;
...
//        getGraphicsData();
    ...
    private void getSumIncome() {
        ...
        if(data.getCount() == 0){
            pemasukkan.setText("Rp. 0.-");
        } else {
            while(data.moveToNext()){
                if(data.getString(0) != null) {
                    pemasukkan.setText("Rp. " + data.getString(0) + ".-");
                } else {
                    pemasukkan.setText("Rp. 0.-");
                }
            }
    ...
    private void getSumOutcome() {
        ...
        if(data.getCount() == 0){
            ...
            while(data.moveToNext()){
                if(data.getString(0) != null) {
                    pengeluaran.setText("Rp. " + data.getString(0) + ".-");
                } else {
                    pengeluaran.setText("Rp. 0.-");
                }
            }
